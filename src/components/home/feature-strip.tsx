...
export function FeatureStrip() {
  return (
    <section className="bg-white border-y border-[#E5E7EB]">
      <div className="grid grid-cols-2 lg:grid-cols-4 max-w-7xl mx-auto divide-x-0 lg:divide-x divide-[#E5E7EB]">
        {ITEMS.map((item, i) => (
          <div key={i} className={`flex items-center justify-center lg:justify-start gap-3 px-4 sm:px-6 lg:px-8 py-6 sm:py-8 group hover:bg-[#F9FAFB] transition-colors duration-300 border-[#E5E7EB] ${i < 2 ? 'border-b' : ''} ${i % 2 === 0 ? 'border-r' : ''} lg:border-b-0 lg:border-r-0`}>
