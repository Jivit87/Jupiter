...
export function TrustFeatures() {
  return (
    <section className="bg-white border-y border-[#E5E7EB] py-8 md:py-12 px-4 sm:px-12" id="trust">
      <div className="max-w-7xl mx-auto grid grid-cols-2 md:flex md:flex-row justify-between items-start md:items-center gap-y-10 gap-x-6 md:gap-4 animate-on-scroll">
