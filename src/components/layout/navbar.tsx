    ...
    >
      <div className="flex items-center justify-between px-4 sm:px-8 lg:px-14 py-4 mx-auto max-w-[1320px]">
        ...
        <div className="flex items-center gap-2 sm:gap-4 -mr-2">
          <SearchTrigger className="w-11 h-11 flex items-center justify-center text-black hover:bg-[#F9FAFB] rounded-full transition-colors relative" />
          <WishlistNavButton className="w-11 h-11 flex items-center justify-center text-black hover:bg-[#F9FAFB] rounded-full transition-colors relative" />
